...
def forward(old_orm, new_orm):
    paymentdata = new_orm['paymentdata']
    return [
        # Apply default value 0 to the field paymentdata.id,
        paymentdata.update({paymentdata.id: 0}).where(paymentdata.id.is_null(True)),
        # Check the field `paymentdata.contract_name` does not contain null values,
        # Check the field `paymentdata.contract_address` does not contain null values,
    ]
