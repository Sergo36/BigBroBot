...
def forward(old_orm, new_orm):
    interaction = new_orm['interaction']
    return [
        # Apply default value 0 to the field interaction.interaction_level,
        interaction.update({interaction.interaction_level: 0}).where(interaction.interaction_level.is_null(True)),
    ]
